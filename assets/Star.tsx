...
interface StarProps extends Size {
  fill: string;
}

const Star: React.FC<StarProps> = ({ width, height, fill }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill="none" viewBox="0 0 20 19">
      <path
        fill={fill}
