...
const OrderContainer: React.FC = () => {
  ...
  const [imageNumber, nextImage, prevImage] = useImageSlider(CafeImages);
  const Menus = [
  ...
  return <Order menuList={Menus} nav={nav} setNav={setNav} reviewList={Reviews} reviewAvg={reviewAvg} reviewStarCount={starCount} imageNumber={imageNumber} cafeImageList={CafeImages} nextImage={nextImage} prevImage={prevImage} />;
};
